...
{
    class RevPortFwdModule : IAgentModule
    {
        AgentController Agent;
        ConfigController Config;

        Dictionary<ReversePortForward, Socket> ReversePortForwards = new Dictionary<ReversePortForward, Socket>();
        List<ReversePortForwardPacket> InboundPackets = new List<ReversePortForwardPacket>();
        ...
        public AgentModuleInfo GetModuleInfo()
        {
            ...
            {
                Name = "rportfwd",
                Description = "Reverse port forwards",
